// Generated by `supabase gen types typescript --local`. Do not edit; regenerate after a migration.
export type Json =
  | string
  | number
  | boolean
    ...
    Tables: {
      ...
      entries: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "entries_counter_account_id_fkey"
          ...
          {
            foreignKeyName: "entries_statement_id_fkey"
      ...
      recurrences: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "recurrences_counter_account_id_fkey"
            columns: ["counter_account_id"]
            isOneToOne: false
            referencedRelation: "accounts"
            referencedColumns: ["id"]
